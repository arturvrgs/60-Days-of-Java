...
public class BudgetTrackerPlus {
    public void BudgetTrackerPlus() {
        ...
        double groceriesPercentage = (groceries/rentPercentage)*100;
        double transportationPercentage = (transportation/rentPercentage)*100;
        double entertainmentPercentage = (entertainment/rentPercentage)*100;
